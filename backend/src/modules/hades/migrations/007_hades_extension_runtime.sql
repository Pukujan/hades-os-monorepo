-- ── hades_extension_documents ──────────────────────────────
-- Stores files and documents uploaded from the extension.
...
-- ── hades_extension_context_spaces ──────────────────────────
-- Stores named text context spaces created from the extension.
...
-- ── hades_extension_page_captures ───────────────────────────
-- Stores captured page content from the browser extension.
...
-- ── hades_extension_approvals ───────────────────────────────
-- Stores pending approval requests for extension-proposed actions.
