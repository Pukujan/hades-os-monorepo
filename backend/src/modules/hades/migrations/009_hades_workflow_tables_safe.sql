...
drop policy if exists "hades_workflow_definitions user owns rows" on hades_workflow_definitions;
...
drop policy if exists "hades_workflow_runs user owns rows" on hades_workflow_runs;
...
drop policy if exists "hades_workflow_audit_logs user owns rows" on hades_workflow_audit_logs;
...
drop policy if exists "hades_workflow_run_checkpoints user owns rows" on hades_workflow_run_checkpoints;
